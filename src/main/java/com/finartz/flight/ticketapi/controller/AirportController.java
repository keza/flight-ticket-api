...
public class AirportController {
    ...
    @GetMapping("/{id}")
    public Airport findById(@PathVariable("id") Long id) throws EntityNotFoundException {
    ...
    @GetMapping("/airports")
    public List<Airport> findName(@RequestParam("name") String name) throws EntityNotFoundException {
